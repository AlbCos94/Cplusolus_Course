...
// We are not going to change the implicit object, therefore we write 'const' at the end
ComplexV2 ComplexV2::operator*() const
{
    return ComplexV2(this->real, -(this->imaginary));
}
}